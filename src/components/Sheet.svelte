...
{#if open}
  <Portal target=".sheets">
    ...
    >
      <div
        class={`fixed bottom-0 left-0 right-0 w-full transition-all duration-200 mx-auto bg-white modal rounded-t-4xl overflow-hidden`}
        in:fly={{
          duration: 300,
          delay: 50,
